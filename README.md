...
```html
<script src="https://cdn.jsdelivr.net/gh/felixeallan/algolia-webflow-filter@v0.7.1/packages/library/dist/algolia-webflow.min.js"></script>
```

**Always pin to a version tag** (e.g. `@v0.7.1`). Do not use `@main` — jsDelivr aggressively caches branch URLs.
